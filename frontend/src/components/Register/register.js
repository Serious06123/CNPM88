        ...
        <>
            <div className="Register" >
                <div style={propNumber ? { width: '80%', position: 'relative', bottom: '-50px' } : {}} className="Register_content">
                    <h3 className="Register_text"><NavLink className="navlink">
                        {propNumber === '2' ? 'Thêm Bác Sĩ' : propNumber === '3' ? 'Thêm Bệnh Nhân' : propNumber === '4' ? 'Thêm Y Tá' : 'Register'}
                    </NavLink></h3>
                    ...
                    <div className="Register_btn">
                        ...
                        <button onClick={handleClickRegister}> <NavLink className="navlink">{propNumber === '2' ? 'Thêm Bác Sĩ' : propNumber === '3' ? 'Thêm Bệnh Nhân' : propNumber === '4' ? 'Thêm Y Tá' : 'Register'}</NavLink> </button>
                    </div>
